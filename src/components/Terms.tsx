...
const Terms: React.FC = () => {
  return (
    <>
      <SEOHead
        title="Terms of Service | CSW Automation - AI Automation for Wellness"
        description="Read the terms of service for CSW Automation's AI chatbot and automation services for wellness businesses, spas, and beauty salons."
        keywords="terms of service, CSW Automation terms, AI service terms, wellness automation terms"
        canonical="https://cswautomation.com/terms"
      />
