...
const PrivacyPolicy: React.FC = () => {
  return (
    <>
      <SEOHead
        title="Privacy Policy | CSW Automation - AI Solutions for Wellness Businesses"
        description="Read CSW Automation's privacy policy to understand how we collect, use, and protect your personal information when using our AI automation services."
        keywords="privacy policy, data protection, CSW Automation privacy, wellness AI privacy"
        canonical="https://cswautomation.com/privacy-policy"
      />
