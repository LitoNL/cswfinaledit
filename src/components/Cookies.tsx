...
const Cookies: React.FC = () => {
  return (
    <>
      <SEOHead
        title="Cookie Policy | CSW Automation - AI Solutions for Wellness"
        description="Learn about how CSW Automation uses cookies to improve your browsing experience and provide better AI automation services for wellness businesses."
        keywords="cookie policy, CSW Automation cookies, website cookies, wellness AI cookies"
        canonical="https://cswautomation.com/cookies"
      />
